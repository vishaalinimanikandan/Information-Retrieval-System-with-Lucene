...
public class App_bm25
{
    
    // Directory where the search index will be saved
    private static String INDEX_DIRECTORY = "cranfield_index";
    private static final String QUERY_FILE = "/Users/hariharan_g/dtrin/irws/lucene-cranfield/corpus/cran.qry";    // File containing the 225 queries
    private static final String RESULT_FILE = "bm_results1.txt"; // File to store the results for TREC Eval
    private static final String DATA_FILE = "/Users/hariharan_g/dtrin/irws/lucene-cranfield/corpus/cran.all.1400";          // File containing all 1400 documents
...
class DocumentToIndex {
    ...
    public DocumentToIndex(int docID, String title, String author, String bibliography, String content) {
        this.docID = docID;
        this.title = title;
        this.author = author;
...
class QueryTuple {
    private final int seqQueryId;  // Sequential Query ID (generated)
    private final int qrelId;      // QREL ID from the .I line
    private final String queryText;  // The query text

    public QueryTuple(int seqQueryId, int qrelId, String queryText) {
        this.seqQueryId = seqQueryId;
        this.qrelId = qrelId;
        this.queryText = queryText;
    }

    public int getSeqQueryId() {
        return seqQueryId;
    }

    public int getQrelId() {
        return qrelId;
    }
